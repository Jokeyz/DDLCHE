label ch0_main:
    ...
    m "Ah, [player]! You must be the new member!"
    m "Welcome back to the club!"
    show monika 1a
    mc "..."
    ...
    m 1a "Plus, now that we have a new member, I think it will help us all get a little more comfortable with each other. It might even lighten the load here."

label ch3_main:
    ...
    if m_appeal == 0 and s_appeal == 0 and n_appeal == 0 and y_appeal == 0 and h_appeal == 0 and l_appeal == 0:
        jump ch3_start_none
    elif m_appeal > 1:
        jump ch3_start_monika
    elif s_appeal > 1:
        ...
        jump ch3_start_harem
    elif l_appeal > 1:
        jump ch3_start_lonely
    else:
        jump ch3_start_none
...
label ch3_start_sayori:
    if not s_exclusivewatched and poemwinner[2] == "sayori":
        call sayori_exclusive_ch3
    else:
        jump ch3_start_none
    return
...
label ch3_start_harem:
    "Harem Route ch3"
    if not h_exclusivewatched and poemwinner[2] == "harem":
        call harem_exclusive_2_ch3
    else:
        jump ch3_start_none
    return


label ch3_start_lonely:
    "Lonely Route ch3"
    if not l_exclusivewatched and poemwinner[2] == "lonely":
        call lonely_exclusive_2_ch3
    else:
        jump ch3_start_none
    return
...
label ch3_start_none:
    ...
    s 1g "[player], I'm super sorry about earlier."
    s "I'm not feeling right now, so I'm going home."
    s 1d "Don't worry about walking me home or anything."
    s "I wouldn't want to distract you from having fun here."
...
label ch3_end:
    ...
    if help_monika:
        ...
        "It's not like we feel that way about each other..."
        "I have nothing to worry about."
        "If I just go with it, then I'll have a good time."
    if HaremCS:
        "My anxiety shoots through the roof."
        "Even though I've gotten pretty used to handling these two at this point..."
        "There's no telling what might end up happening when we're outside of school."
        "More than that...they told me that they was looking forward to it."
...
label ch3_end_monika:
    ...
    show monika 1d zorder 3 at h32
...
label ch3_end_harem:
    ...
    $ HaremCS = True
    mc "Well, baking sounds like it could be fun..."
    mc "But I would probably be most useful helping out Yuri..."
    mc "And Sayori lives next door, so if I'm going to help anyone out."
    mc "It should be her."
    ...
    y "Mmm?"
    show yuri at t33
    mc "Well since, everyone sounds like we could all use each other's help."
    mc "Why don't we all work together?"
    mc "And we could even use my house so that way I can contribute."
    show monika 1l zorder 3 at f32
    m "I think that..."
    show monika zorder 2 at t32
    show natsuki 2c at f31
    n "I'd be fine with that."
    show natsuki at t31
    show yuri 2h zorder 3 at f33
    y "I wouldn't mind another extra set of hands either."
    show yuri zorder 2 at t33
    show monika 1d zorder 3 at f32
    m "Really?"
    mc "Is that okay, then?"
    m 3a "I suppose so."
    show monika at t32
    show natsuki 1k at f31
    n "So, that's everything, right?"
    n "Anything else we need to talk about?"
    show natsuki at t31
    show monika 3e at f32
    m "No, I think that's it..."
    m 3b "Are you guys excited?"
    show monika at t32
    show natsuki 4z at f31
    n "Yes!"
    n 4y "Everything except the performance is gonna be awesome!"
    show natsuki at t31
    mc "I don't think that really counts..."
    show monika at f32
    m "What about you?"
    mc "Me?"
    mc "Ah, I guess you could say I'm interested to see how it'll turn out..."
    m 1a "That's good enough for me!"
    show monika at t32
    show natsuki 1q zorder 3 at f31
    n "Yuri."
    n "You really are the most talented one here."
    ...
    n "And you're going to help make the event a lot more fun and welcoming."
    show natsuki zorder 2 at t31
    show yuri 2i zorder 3 at f33
    y "Well Natsuki."
    y 2j "Your cupcakes are the best cupcakes I've ever had!"
    y "They go really well with my tea!"
    y "And nothing that I do for the event will compare to that."
    y 2b "So..."
    show yuri at t33
    show natsuki 1e at f31
    n "I mean, the cupcakes will probably help a lot too..."
    n "But you're gonna make the atmosphere special."
    n 4d "That'll be really important for the way that people feel during the performances."
    show natsuki at t31
    mc "So let's all give it our best to work together."
    mc "And we'll make the festival great!"
    show monika 2k zorder 3 at f32
    m 2b "I hope to see everyone do their best."
    m "But with that..."
    m "There's nothing more for today."
    ...
    play music t6 fadeout 1
    show natsuki 4g zorder 2 at f21
    show yuri 1a zorder 3 at t22
    n "Um, where are you going?"
    mc "Eh...?"
    n 4c "We still need to figure out our plans for this weekend."
    n "You literally would've gotten home and realized that you didn't even have a way to contact me."
    ...
    n 4e "Okay..."
    n "We're coming over on Sunday"
    n "I'll bring all the ingredients I can."
    y "And I'll be stopping on the way over to pick up anything else we may need."
    mc "Wait!"
    show natsuki 2c
    mc "If everyone is bringing this much, should we do at one of your houses?"
    n 2e "Yeah, right."
    n "Like I could have a guy over my house..."
    n 4h "My dad would kill me."
    mc "Really?"
    mc "That's kinda strict, if you ask me."
    n 5s "Yeah, how do you think I feel?"
    n 5q "I can't do anything when my dad is home..."
    show natsuki at t21
    show yuri 3f at f22
    y "And if you don't mind..."
    y "I think I would prefer going to your house as well."
    show yuri at t22
    mc "Alright."
    mc "In that case, it won't be a problem"
    "I decide not to press Yuri for a reason."
    "It's not like it should matter much either way, so I'll just need to make sure my room and the kitchen is clean."
    show natsuki 2k at f21
    n "Anyway..."
    n 2b "We have each other's numbers now."
    n "That's all I needed from you."
    show natsuki 2c at t21
    mc "I hope I manage to make myself useful in some way..."
    mc "I'm not nearly as skilled as you both are."
    show yuri 2b at f22
    y "Don't underestimate yourself."
    y 3s "I think that we'll make a very productive team."
    y 4b "Even if you only included me because you felt bad or something..."
    mc "Wait...!"
    mc "You don't actually think that, do you?"
    y "..."
    y 4a "I...don't know."
    y 1s "It's difficult to come up with any other reason you may have chosen me..."
    mc "You're forgetting the one reason with the most common sense!"
    mc "I wanted to include you because that's what I want to do."
    y 4b "B-But..."
    "Yuri thinks to herself with an extremely tense expression."
    mc "Yuri...you're overthinking this."
    mc "You wanted me to point out when you're overthinking, right?"
    ...
    mc "Alright, fine by me."
    n "Yeah."
    n 4d "I'm really gonna show you why I love baking so much."
    n 4z "So you'd better look forward to it."
    mc "Oh?"
    mc "Didn't you say you were just going to give me the dirty work?"
    show natsuki 1p at hf21
    n "Well-!"
    n 5n "I was kinda looking forward to this."
    mc "Wait, really?"
    n 2b "Well, kind of!"
    n 2u "Just because...I never got to bake with someone else before."
    show natsuki at t21
    show yuri 3s at f22
    ...
    show yuri at t44
    mc "See you on Sunday."
    show natsuki 1h at h43
    n "Ah-"
    show natsuki at t32
    show yuri at t33
    "I turning back."
    show natsuki 1u at f32
    n "..."
    n 4q "...Never mind."
    show natsuki at t32
    mc "Oh, Okay"
...
label ch3_end_lonely:
    $ch4_scene = "lonely"
    m 3k "Why don't you..."
    m 3l "Uhh..."
    m 3n "Work on creating the best poem you can."
    m 1j "You'll need all the experience you can get to catch up to everyone else."
    show monika at t32
    mc "Ah-"
    mc "That's..."

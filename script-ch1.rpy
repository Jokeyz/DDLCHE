...
label ch1_main:
    ...
    "Instead it seems like Monika's head is somewhere else completely"
    "Sayori seems to be cheering up Monika about it thought."
...
label ch1_end_monika:
    ...
    show monika 1d zorder 3 at r44
    "I grasp at straws and then look over to see Monika sitting in a desk quietly."
    show monika 1e
    "She looks up at me quizzically. After a second, she smiles at me."
    show monika 1e at f44
    ...
    show monika zorder 1 at t44
    show yuri at t42
    show natsuki at t43
    show sayori 5b zorder 2 at l41
    ...
    show natsuki 1n at t44
    show yuri at t11
    play music t10
    y 1w "See what you've done now?"
    mc "Is Monika okay?"
    s 1g "Yeah, the fighting must have just gotten to her a little bit. You can go check on her if you want. I'm sorry for all this."
    ...
    show monika 1o zorder 3 at t11
    play music t9
    "I find Monika hiding in her classroom."
    ...
    m 3l "You understand, right?"
    m "Anyway..."
    m "Don't let this want to make you spend less time with the others."
    m "I appreciate you coming to check up on me though."
    show monika 4j
    ...
    play music t3
    show natsuki 2z zorder 1 at t44
    show yuri 2d at t43
    ...
    show sayori 2a zorder 3 at t42
    show monika 1a at l41
    mc "Wow Sayori, what did you say to make this happen?"
    s 2r "That's a secret."
    s 2l "I hope that this doesn't sour your taste of the club though."
    s 1a "They may have not shown it the right way but everyone here got all excited over you being here."
    show monika zorder 3 at f41
    m 2b "Sayori, you always amaze me."
    m "Things are just awful when you're not around."
    show monika zorder 1 at t41
    show sayori 2s
    "Sayori blushes at the compliment"
    show sayori zorder 3 at f42
    s 2y "Well I appreciate that Monika, but if it weren't for you. None of us would even be here."
    s "So don't be too hard on yourself, okay?"
...
label ch1_end_harem:
    ...
    show sayori 4b at l42
    show yuri at t43
    show natsuki at t44
    pause .5
    show natsuki 4e at f44
    n "Would everyone stop staring at me?"
    show monika 1l
    show sayori 1l
    "Unsurprisingly, Natsuki has a harder time with it than she boasted."
    show monika at lhide
    ...
    show sayori zorder 3 at f41
    s 4h "Ehh?"
    s 4p "I was just trying to help!"
    mc "I'm sure she appreciated it, Sayori."
    show sayori 4h zorder 2 at t41
    n 2c "I think I'm going to take a little walk to clear my head."
    ...
    show yuri 1v at l21
    mc "Everything alright?"
    y 3u "I'm so embarrassed..."
    y 3w "I can't believe I acted like that."
    y "You probably hate me now..."
    mc "No-Yuri!"
    show yuri 3n at h21
    mc "How could anyone not have gotten frustrated after being treated like that?"
    ...
    mc "I don't think any less of you."
    y 3u "Well..."
    y 1b "...Alright, I believe you."
    show sayori 4r
    y 3j "Thanks, [player] You're too kind."
    y "I'm thankful to have you a part of this club now."
    mc "Er- It's nothing."
    y 1f "One more thing..."
    y 3t "Um, that one thing that Natsuki said..."
    y 4e "About...you know..."
    show sayori 1e
    y "I would never do anything...so shameful..."
    y "So..."
    ...
    mc "What thing did Natsuki say?"
    show yuri 2p at h21
    show sayori 1n at h22
    y "-!"
    y "U-Um!"
    y 2o "Well, never mind that..."
    y 1q "I-I'm going to go make some tea..."
    show yuri at lhide
    hide yuri
    show sayori at t11
    mc "Ah, good idea."
    ...
    m "Well, now that we're past that..."
    show sayori at t22
    show monika 4m zorder 2 at l21
    m 4b "Everyone's read each other's poems, right?"
    m "I hope that it was worthwhile for everyone!"
    m 5 "Especially you, [player]!"
    m "And to be honest..."
    ...
    s 2i "That's not the most important thing about the literature club!"
    s "The most important thing..."
    show sayori 4r zorder 3 at hf22
    s "Is having fun!"
    show sayori zorder 2 at t22
    show monika zorder 3 at f21
    m 2l "Ahaha, of course..."
...
label ch1_end_lonely:
    ...
    show monika 1d zorder 3 at r33
    "I grasp at straws and then look over to see Monika sitting in a desk quietly."
    show monika 1e
    "She looks up at me quizzically. After a second, she smiles at me."
    ...
    show yuri at t42
    show natsuki at t43
    show sayori 5b zorder 1 at l41
    "Sayori looks incredibly uncomfortable."
    stop music fadeout 2.0
    show monika 1p at t44
    pause 0.5
    ...
    mc "Is Monika okay?"
    s 1g "Yeah, the fighting must have just gotten to her a little bit. You can go check on her if you want. I'm sorry for all this."
    "I decide to leave Monika alone and not bother her."
    ...
    show monika 3k at t21
    "Meanwhile Monika and Sayori are talking with each other about some club business."
    return
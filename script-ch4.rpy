label ch4_main:
    ...
    if ch4_scene == "harem":
        ...
        "I keep telling myself there's no reason to be nervous, but it doesn't help much."
        "I wonder if Natuski's will act any different?"
        "Meanwhile, she's been texting me a lot."
        "We sent each other one after exchanging numbers to double-check, but it turned into conversation."
        "She's almost a different personality on the phone, using tons of emoji and cute language."
        "She also really likes complaining about things, but I kind of saw that one coming."
    ...
    if ch4_scene == "harem":
        s "Aren't you supposed to be have people over today?"
    else:
    ...
    s "Yeah."
    if ch4_scene == "harem":
        mc "Why don't we do something special for it?"
    else:
    ...
    mc "But..."
    if ch4_scene == "harem":
        mc "It's almost time for all of us to meet at my house..."
    else:
        mc "It's almost time for [ch4_name] to meet me at my house..."
    mc "At the very least, do you want to come along and help out?"
    mc "It would be fun."
    "To my surprise, Sayori nods her head."
    if ch4_scene == "harem":
        s 1bj "I suppose if it's already going to be half the club."
        s 2bd "That either Monika or I should be there to be a leader."
        "I help Sayori get ready as fast as possible and then we rush over to my house."
        call ch4_exclusive_harem
        return
    s 1bd "I'm sorry."
...
#Changed
    ...
    if help_monika:
        ...
        "To be honest, I don't know Monika that well. I've only known her in passing and never spent time with her."
        mc "I can't really say, why?"
        y 1bg "Something just seems off to me."
        y "Like she's lying to us about something."
        mc "What do you mean?"
        y 1bh "Playing a harp shouldn't be causing that much damage to one's fingers."
        mc "What do you think it is then?"
        y "I don't know, but the marks on her fingers aren't just a harp."
        mc "How would you know?"
        y 3bn "Uh..."
        y 3bq "Just call it a woman's intuition."
        y "Besides, it's not like I'd know too much about that kind of stuff."
    hide yuri
    with wipeleft
...
label ch4_end:
    ...
    s 1bv "Monika was wrong..."
    s "I should just..."
    mc "Monika...?"
    mc "Monika was wrong about what?"
    s "..."
    mc "Sayori..."
    ...
    s "[player]..."
    s 4bw "I like you so much that I can't stand it!"
    s "That's how I feel!"
    s 2bv "And...and..."
...
label ch4_end_yes:
    ...
    s "You'll be there for me...right?"
    mc "Eh...?"
...
label ch4_end_no:
    ...
    mc "Did you and Monika get everything done you needed to?"
    show sayori 1bb
    "It seems to work as Sayori becomes distracted."
    s 1bb "I haven't heard from her at all"
    s "Which is weird, because she's typically good about responding back quickly."
    mc "Do you think everything is alright?"
    s 1bc "I was actually thinking about going to check up on her."
    s "She doesn't live that far away from here."
    s "Would you want to come with me?"
    mc "Um well..."
    mc "Sure"
    ...
    s "Yeah?"
    mc "I really mean it."
    mc "I know things are bad right now."
    mc "But I'm going to be your friend through all of this."
    mc "I want to help you through this."
    show sayori 4bq
    "Sayori smiles at that."
    "The smile is genuine."
    stop music fadeout 1
    scene mhouse with wipeleft_scene
    ...
    show groom with wipeleft_scene  
    hide monika
    hide sayori
    show monika 2bd at f22
    show sayori 1ba at t21
    m "What brings you here?"
    m "I didn't mess something up again, did I?"
    show monika at t22
    show sayori 4bi at f21
    s "No, it's not anything like that."
    s 1bg "We were just worried is all."
    s "You weren't answering me back and..."
    show sayori at t21
    mc "We wanted to make sure you're okay?"
    show monika 1bm at t22
    "Monika seems completely blown away by this."
    show monika at f22
    m "Well this is a surprise."
    m 3bo "I'm sorry for not answering you, Sayori."
    m "I was really tired and spent most of the day in bed."
    show monika at t22
    show sayori at f21
    s 3bb "Are you feeling alright?"
    show sayori at t21
    show monika 2be at f22
    m "I think so."
    m "Just a lazy day I guess."
    show monika at t22
    show sayori 3bc at f21
    s "Well now that we're here, shouldn't we work on the stuff for the festival?"
    show monika 1bi at h22
    "Monika panics for a second."
    show sayori at t21
    show monika 2bl at f22
    m "Oh no!"
    m "I completely forgot."
    m "I mean we never get to..."
    m 1br "I'm so sorry Sayori."
    show monika at t22
    show sayori 3ba at f21
    s "It's fine, I'm sure we can put something together."
    show monika at lhide
    hide monika
    m "Let me get the tools first, okay"
    show sayori at t21
    "."
    ".."
    "..."
    show sayori at t22
    show monika 1ba at l21
    ...
    show sayori 1ba at t21
    show monika 2be at f22
    m "I'm still so sorry for dragging you two into this."
    m "I really didn't mean to."
    m "I guess I just haven't felt like doing anything recently."
    show monika at t22
    show sayori 4bx at f21
    s "It's okay."
    s "We all have days like that."
    s "What's important is having friends around that can help you with that?"
    s "Isn't that right?"
    show sayori at t21
    ...
    if help_monika:
        ...
        show sayori 3bb at t11
        s "You noticed it too right?"
        mc "Noticed what?"
        s "She must've spent all day in bed."
        mc "Hmm"
        mc "Yeah I thought about that but I didn't want to say anything."
        s 1bd "I hope whatever is bringing her down isn't anything too bad."
        mc "What do you mean?"
        s 1bh "Oh, so you didn't notice?"
        mc "Notice what?"
        s 1bk "Something is definitely up with her."
        s "I just hope it all ends up working out."
        mc "How do you even know something is up?"
        s "Let's just call it a woman's intuition."
        mc "Sayori."
        s 3bb "Hmm?"
        mc "I completely give up on ever understanding you."
        show sayori 4bq 
        "Sayori giggles a little bit."
        s 4br "That's fine."
        s "As long as we're friends."
...
label ch4_exclusive_harem:
    play music t6 fadeout 2.0
    scene bg house with wipeleft_scene
    show sayori 1bb at t31
    show natsuki 4bi at t32
    show yuri 1be at t33
    "Yuri and Natsuki are already there waiting for me."
    mc "I'm sorry about the wait."
    mc "But I brought along some more help."
    "I immediately notice that Yuri and Natsuki are both carrying a lot."
    mc "Oh wow, you brought a lot with you."
    y 1bf "That's right."
    y "And did you manage to find everything I asked you to buy as well?"
    mc "Yeah, pretty much."
    show yuri 1ba at t33
    ...
    "Seeing her in such cute clothes makes the uniform seem totally unfitting in comparison."
    n 4be "Jeez, don't make it feel so awkward already!"
    n "It's gonna be a long afternoon, so don't be weird just because you're not used to seeing me outside of school."
    n 4bc "Anyway, We're going in."
    "Natsuki hands me a large bag that is probably full of baking supplies."
    mc "I see you also brought a lot of stuff."
    ...
    s 4bx "I call dibs on helping Natsuki first!"
    "I'm taken aback by Sayori's intervention."
    "I don't complain because she just got me out of a tight spot."
    show natsuki 4be at f32
    n "Huh?"
    show natsuki at t32
    show sayori 2bq at f31
    s "If I don't help you first, I won't get to lick the spatulas."
    show sayori at t31
    show natsuki 3bq at f32
    n "God, Sayori."
    n "You can be so childish sometimes."
    n 4bc "Let's get started I guess."
    show natsuki at t32
    ...
    show yuri at t11
    mc "I guess we'll go get started in my bedroom then."
    scene bg bedroom with wipeleft
    "I take Yuri to my room."
    "The first thing she does is glance around curiously, which makes me feel anxious."
    show yuri 2bm zorder 2 at t11
    ...
    show natsuki 4be at t32
    show yuri 3bn at rface
    n "That's IT!"
    n "Sayori, go help Yuri!"
    show yuri at t33
    "Yuri and I both jump back at Natsuki's shout."
    show natsuki 4bg
    show sayori 4bp at l31
    show yuri 1be
    "A few seconds later Sayori comes into my room sheepishly."
    s "Natsuki kicked me out for eating too much."
    show yuri 1bc
    "Yuri and I can't help ourselves and both end up laughing."
    "I stand up and clean my hands with the towel."
    mc "I suppose I should go help Natsuki then."
    mc "Unless you'd like to eat some paint as well, Sayori."
    show sayori 1bb at f31
    s "Oh we're painting?"
    show sayori at t31
    show yuri 1bb at f33
    y "Indeed."
    show yuri at t33
    show sayori 1bx at f31
    s "That sounds like a lot of fun."
    ...
    "More than that..."
    "Did I even take the opportunity to get closer to her, like I wanted?"
    "Natsuki is the first to walk out so I follow her out while Yuri and Sayori finish packing up."
    show natsuki 1bh zorder 2 at t11
    n "Well..."
    n "I guess I'll be off, then..."
    n 1bq "Thanks for all the help and everything..."
    ...
    s 1bq "Ehehe~"
    s "It's okay, [player]."
    s 1ba "I just stopped by to say goodbye~"
    show sayori zorder 2 at t21
    show yuri zorder 3 at f22
    y 3bq "U-Um..."
    y "Well, it's nice to see you..."
    ...
    "Sayori waves goodbye after her."
    mc "Sayori--"
    mc "You seemed so down to start today."
    s 2bl "But it looks like you had a lot of fun."
    s 1by "So I had to come here and see it for myself."
    mc "See what?"
    mc "What are you talking about?"
    s "You know..."
    s "How much fun you were having with."
    s "And how close you got to her."
    s 1bt "It makes me...really happy..."
    s "That you've made such good friends."
    s "That's all that matters to me."
    ...
    mc "But I don't want to take advantage of what you're going through."
    mc "So I'm not going to answer to your feelings until you start to get better."
    mc "But I'm also not going to reject your feelings."
    s "Eh-?"
    mc "Those are my true feelings."
    mc "I should have realized it sooner."
    mc "But spending time with everyone at the club..."
    mc "Making new friends..."
    mc "And having fun with you every day..."
    mc "It helped me realize that you are truly incredibly important to me."
    mc "That's why I'll accept any of your burdens."
    mc "As long as we continue like this every day..."
    mc "With you by my side..."
    ...
    "Sayori is the most important person to me."
    "And I'll do whatever it takes to have a happy future with her."
    show monika 2be at l41
    m "You just gonna stand there and not say hi~"
    "Monika's voice snaps me back to reality."
    "I must've jumped because she giggles a little."
    show monika 1bn at t11
    m "I didn't mean to scare you or anything."
    mc "No, it's alright."
    mc "I was thinking about something."
    m 1be "I know."
    m "You're walking a dangerous line you know."
    m 2be "Not many people can have their cake and eat it too."
    mc "What do you mean?"
    show monika 2bq
    "Monika pauses for a minute, seeming to be thinking through carefully what she wants to say."
    m 4be "Just be careful not to be playing with club members' feelings."
    m "Especially not mine."
    m 1be "I'd hate to see all your efforts go to waste."
    "I can't quite follow what Monika is saying."
    mc "I'm trying not to play with anyone's feelings."
    mc "I just want everyone to be happy."
    m 2bh "And what if there is someone who isn't happy."
    m "What if there is someone who feels left out?"
    "Reality hits me like a truck."
    "Monika must have felt incredibly alone today."
    "We didn't intend to leave her out today."
    mc "Monika"
    mc "I'm sorry."
    mc "Today wasn't supposed to turn out like it did."
    mc "But that doesn't mean we shouldn't have included you."
    mc "I was just worried at you seeing my house."
    show monika 1bd
    mc "I can't explain why, but something about you makes me feel incredibly nervous."
    "Monika looks at me confused."
    mc "It's just..."
    mc "You're really pretty..."
    mc "...and popular..."
    mc "...and I can't understand why you'd ever want to spend time with me."
    m 1br "I wonder if that's why we don't have an ending together."
    mc "What's that?"
    "Monika seems to focus back on me."
    m 2be "Never mind."
    m "Even if that's how you feel."
    m 1bs "I would like to spend some time with you."
    mc "How about this then?"
    mc "I promise I'll spend time with you tomorrow at the festival."
    m 1bb "Really?"
    mc "Of course!"
    mc "I feel like I've barely gotten to talk to you."
    mc "And I really want to get to know you better."
    mc "Even if it's only going to make things more hopeless for me."
    show monika 1ba
    ...
    m 4bj "Okay."
    m "I'm gonna hold you to it then."
    m 4bk "And it'd better be a great date then~"

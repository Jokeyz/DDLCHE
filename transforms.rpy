...
transform rightin(x=640, z=0.80):
    xcenter 1600 yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    easein .25 xcenter x
...
transform rface(z=0.80, y=500):
    ...
    yoffset y
    zoom z*1.95
    easein .25 xcenter 1080 yoffset 500 zoom z*2.00 alpha 1
transform rsface(z=0.80, y=500):
    subpixel True
    alpha 0
    xcenter 1080
    yanchor 1.0 ypos 1.03
    yoffset y
    zoom z*1.95
    easein .5 xcenter 1080 yoffset 500 zoom z*2.00 alpha 1
transform tface(z=0.80, y=500):
    subpixel True
    on show:
        alpha 0.00
        zoom z*2.00
        xcenter 640 yoffset -300
        easein .5 alpha 1.0
    on replace:
        easein .25 xcenter 640 yoffset -300 zoom z*2.00
transform uface(z=0.80, y=500):
    subpixel True
    on show:
        alpha 0.00
        zoom z*2.00
        xcenter 640 yoffset y
        easein .5 alpha 1.0
    on replace:
        easein .25 xcenter 640 yoffset y zoom z*2.00

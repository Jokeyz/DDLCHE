...
label ch2_main:
    ...
    show monika zorder 3 at f41
    m 1m "I must not have heard it, since I was practicing harp..."
    show monika zorder 2 at t41
    ...
    m 1m "Something about the pain of the strings on my fingers."
    show monika zorder 2 at t41
...
label ch2_end:
    ...
    show monika zorder 3 at f43
    m 1l "Oh gosh..."
    m 1n "You'll be fine this time, Yuri."
    m "But anyway..."
...
label sayori_ask:
    s 1a "So...let's just say that one day, someone asked to walk home with you..."
    mc "Huh?!"
    s "What would you do?"
    mc "What kind of question is that...?"
    mc "You're kind of putting me on the spot here..."
    ...
    menu:
        "Well..."
        "I would walk home with everyone.":
            call ch2_end_harem
...
label ch2_end_yuri:
    ...
    s 1x "Isn't she so cool and calm?"
    jump ch2_end_shared
...
label ch2_end_monika:
    ...
    "Why does the thought of that make my heart pound...?"
    mc "I mean..."
    mc "I think she will run away if I turned her down..."
    s 1x "Isn't she so beautiful and smart?"
    jump ch2_end_shared

label ch2_end_harem:
    mc "I would suggest we all walk home together."
    s 1b "Huh?"
    mc "I mean..."
    mc "I think I would be afraid of what Natsuki'd do to me if I turned her down..."
    mc "And with Yuri."
    mc "Given how hard it is for her to socialize, I would feel awful turning her down, so..."
    mc "But Sayori,"
    mc "I wouldn't want to ditch you either."
    s 4j "Eh?!"
    s "B-But..."
    jump ch2_end_harem2

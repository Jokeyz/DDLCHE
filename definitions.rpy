...
image monika 5z = im.Composite((960, 960), (0, 0), "monika/3ab.png")
...
image monika 1bu = im.Composite((960, 960), (0, 0), "mods/monika/1lb.png", (0, 0), "mods/monika/1rb.png", (0, 0), "mods/monika/cr1.png")
...
define l = Character("")
define h = Character("")
define c = DynamicCharacter('c_name', image='man', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
$ c_name = "Man"
...
#Cdef
define h_poemappeal = [0, 0, 0, 0, 0, 0]
define l_poemappeal = [0, 0, 0, 0, 0, 0]
define h_appeal = 0
define l_appeal = 0
...
default h_poemappeal = [0, 0, 0, 0, 0, 0]
default l_poemappeal = [0, 0, 0, 0, 0, 0]



default poemwinner = ['lonely', 'lonely', 'lonely', 'lonely', 'lonely']
default rpointwinner = ['lonely']
...
default HaremCS = False


default m_exclusivewatched = False
default s_exclusivewatched = False
default n_exclusivewatched = False
default y_exclusivewatched = False
default h_exclusivewatched = False
default l_exclusivewatched = False

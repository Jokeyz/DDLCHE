init python:
    menu_trans_time = 1
    splash_message_default = "This game is not offcial and Safe to Play!.\n\n~Jokeyz~"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "Doki Doki Literature Club Happy End is a DDLC fan mod that not affiliated with Team Salvato."
        "This mod require Official Doki Doki Literature Club game that can be download at http://ddlc.moe, in order to play this mod."
        "Doki Doki Literature Club Happy End  -  Everyone Happy End!"
        menu:
            "By playing Doki Doki Literature Club Happy End, you agree that you have complete play the original version."
            "I agree.":
                pass
